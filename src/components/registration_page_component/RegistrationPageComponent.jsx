  ...
  return (
      <div className="registration__form__icons">
        ...
        <div className = 'registration__form__icons__topleft__div'>
          <img src={ brands.length > 3 ?  brands[3].logo : icon} className="registration__form__icons__topleft" alt = 'brand icon'/>
        </div>

        <div className = 'registration__form__icons__topright__div'>
          <img src={brands.length > 3 ? brands[2].logo : icon } className="registration__form__icons__topright" alt = "svg random"/>
        </div>

        <div className = 'registration__form__icons__bottomleft__div'>  
          <img
            src={brands.length > 3 ? brands[0].logo : icon}
        ...
        <div className = 'registration__form__icons__bottomright__div'>
          <img
            src={brands.length > 3 ? brands[1].logo : icon}
